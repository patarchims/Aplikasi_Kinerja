...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            <?= form_open_multipart('karyawan/karyawan_edit'); ?>
    ...
    <div class="form-group row">
        <label for="no_hp"  class="col-sm-2 col-form-label">Access</label>
        <div class="col-sm-10">
        <select class="custom-select" name="role" id="role">        
                <?php foreach ($access as $s) : ?>   
                    <?php if(  $s['id'] == $user['role_id']) :  ?>   
    ...
    <div class="form-group row">
        <label for="no_hp"  class="col-sm-2 col-form-label">Is Active?</label>
         <div class="col-sm-10">
